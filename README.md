...
I'm a 3rd-year Computer Science student with a strong passion for **problem solving** and **software development**. My journey began with the fundamentals of programming and has grown into mastering **Data Structures & Algorithms** while building full-stack web applications.

I believe in continuous learning — consistently sharpening my problem-solving skills through coding challenges and hands-on projects. My goal is to become a **skilled Software Engineer**, capable of building efficient, scalable, and impactful software solutions.
...
```typescript
const sahilKumarSingh = {
  title: "B.Tech Computer Science Student | Full Stack Developer | DSA Enthusiast",
  ...
  certifications: [
    "Oracle Cloud Infrastructure (OCI) AI Foundations Associate — Oracle",
    "Gemini for Google Workspace — Simplilearn",
    "Deloitte Cyber Job Simulation — Deloitte Forage",
    "Introduction to Cybersecurity — Cisco Networking Academy",
  ],

  status:  "3rd-year CS student, continuously learning and building real-world projects",
  openTo: ["Software Engineering roles", "Collaborative full-stack projects", "DSA & problem-solving discussions"],
} as const;
```
...
<table width="100%">
<tr>
<td align="right" width="280"><b>Languages</b></td>
<td align="center" width="620"><img src="https://skillicons.dev/icons?i=java,js,python,cpp" /></td>
</tr>
<tr>
...
<td align="center" width="620"><img src="https://skillicons.dev/icons?i=nodejs,express" /></td>
</tr>
<tr>
...
<td align="center" width="620"><img src="https://skillicons.dev/icons?i=git,github" /></td>
</tr>
<tr>
<td align="right" width="280"><b>Dev Tools</b></td>
<td align="center" width="620"><img src="https://skillicons.dev/icons?i=vscode,postman" /></td>
</tr>
</table>
...
<table>
<tr><td><b>Certification</b></td><td><b>Issued By</b></td></tr>
<tr><td>Oracle Cloud Infrastructure (OCI) AI Foundations Associate</td><td>Oracle</td></tr>
<tr><td>Gemini for Google Workspace</td><td>Simplilearn</td></tr>
<tr><td>Deloitte Cyber Job Simulation</td><td>Deloitte Forage</td></tr>
<tr><td>Introduction to Cybersecurity</td><td>Cisco Networking Academy</td></tr>
</table>
